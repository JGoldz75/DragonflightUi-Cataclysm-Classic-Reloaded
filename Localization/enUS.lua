...
L["UnitFrameFadingBars"] = "Fading Bars"
L["UnitFrameFadingBarsDesc"] = "Animate a short trail when health or power drops."
...
L["TargetFrameHitIndicators"] = "Hit Indicators"
L["TargetFrameHitIndicatorsDesc"] =
    "Show damage numbers over enemy portraits when party or raid members damage that unit."
L["TargetFrameDebuffSize"] = "Debuff Size"
L["TargetFrameDebuffSizeDesc"] = "Set target debuff icon size. 0 keeps the default size."
L["TargetFrameDebuffPersonalScale"] = "My Debuff Scale"
L["TargetFrameDebuffPersonalScaleDesc"] = "Make debuffs you cast larger than other target debuffs."
L["TargetFrameDebuffsMineFirst"] = "My Debuffs First"
L["TargetFrameDebuffsMineFirstDesc"] = "Place debuffs you cast before other target debuffs."
L["TargetFrameDebuffTimersMineOnly"] = "Only My Debuff Timers"
L["TargetFrameDebuffTimersMineOnlyDesc"] =
    "Show countdown numbers only on target debuffs cast by you or your controlled units."
L["TargetFrameDebuffOffsetX"] = "Debuff X Offset"
L["TargetFrameDebuffOffsetXDesc"] = "Move target debuffs left or right after Blizzard places them."
L["TargetFrameDebuffOffsetY"] = "Debuff Y Offset"
L["TargetFrameDebuffOffsetYDesc"] = "Move target debuffs up or down after Blizzard places them."
L["TargetFrameDebuffSpacing"] = "Debuff Spacing"
L["TargetFrameDebuffSpacingDesc"] = "Adjust the horizontal spacing between target debuffs. Negative values pack them tighter."
