...
function DragonflightUIBossframeMixin:UpdateFadingBars()
    local unitframeModule = DF:GetModule('Unitframe', true)
    local bossModule = DF:GetModule('Bossframe', true)
    local enabled = bossModule and bossModule.db and bossModule.db.profile.boss.fadingBars

    if unitframeModule and unitframeModule.SetupFadingBarsForUnit then
        unitframeModule.SetupFadingBarsForUnit(self.HealthBar, self.ManaBar, enabled)
    end
end

function DragonflightUIBossframeMixin:ResetFadingBars()
    local unitframeModule = DF:GetModule('Unitframe', true)
    if unitframeModule and unitframeModule.ResetFadingBarsForUnit then
        unitframeModule.ResetFadingBarsForUnit(self.HealthBar, self.ManaBar)
    end
end
...
function DragonflightUIBossframeMixin:UpdateHealth(unit)
    ...
    local unitframeModule = DF:GetModule('Unitframe', true)
    if unitframeModule and unitframeModule.SyncFadingBar then unitframeModule.SyncFadingBar(self.HealthBar) end
...
function DragonflightUIBossframeMixin:UpdatePower(unit)
    ...
    local unitframeModule = DF:GetModule('Unitframe', true)
    if unitframeModule and unitframeModule.SyncFadingBar then unitframeModule.SyncFadingBar(self.ManaBar) end
